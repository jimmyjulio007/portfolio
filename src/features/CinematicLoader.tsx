      ...
      const tl = gsap.timeline({
        onComplete: () => {
          ...
          columnsContainer.className =
            "fixed inset-0 z-[10000] pointer-events-none flex";
          columnsContainer.id = "reveal-columns";

          for (let i = 0; i < 12; i++) {
            const col = document.createElement("div");
            col.className =
              "flex-1 h-full bg-gradient-to-b from-[#00f0ff] via-[#0088ff] to-black origin-bottom";
          ...
          <div className="relative">
            ...
            <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full border-2 border-[#00f0ff]/30 flex items-center justify-center">
              ...
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-[#00f0ff]/20 to-[#ccff00]/20 flex items-center justify-center">
                <div className="text-lg sm:text-xl md:text-2xl font-bold text-[#00f0ff]">
                  JJ
                </div>
              </div>
            </div>
            {/* Rotating ring */}
            <div
              className="absolute inset-0 rounded-full border-2 border-transparent border-t-[#ccff00]/50 animate-spin"
